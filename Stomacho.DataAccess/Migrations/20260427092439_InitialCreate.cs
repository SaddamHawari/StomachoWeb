        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cuisine = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Restaurants",
                columns: new[] { "Id", "Cuisine", "ImageUrl", "IsActive", "Location", "Name" },
                values: new object[,]
                {
                    { 1, "Indian & Chinese", "", true, "Shankhamul", "ShandarMomo" },
                    { 2, "Mexican & Thai", "", true, "Baneshwor", "SpicyBites" },
                    { 3, "Italian & Continental", "", true, "Lazimpat", "FlavorsHub" }
                });

            migrationBuilder.InsertData(
                table: "MenuItems",
                columns: new[] { "Id", "Description", "ImageUrl", "IsAvailable", "Name", "Price", "RestaurantId" },
                values: new object[,]
                {
                    { 1, "Steamed dumplings filled with spiced chicken.", "", true, "Chicken Momo", 220.0, 1 },
                    { 2, "Stir-fried rice noodles with tofu, peanuts, and lime.", "", true, "Thakali Khana", 450.0, 2 },
                    { 3, "Classic pizza with tomato sauce, mozzarella, and basil.", "", true, "Margherita Pizza", 680.0, 3 }
                });
